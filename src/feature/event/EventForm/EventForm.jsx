    ...
    return (
        <Segment>
            ...
            <Form.Field>
                ...
                <input name='title' onChange={this.onInputChange} value={event.title} ref="title" placeholder="Event Title" />
            </Form.Field>
            <Form.Field>
            ...
            <Button onClick={handleCancelForm} type="button">Cancel</Button>
            </Form>
        </Segment>
    )
  }
